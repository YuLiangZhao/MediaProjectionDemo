...
Java_com_cry_screenop_recorder_rtmp_RtmpHandle_pushFile(JNIEnv *env, jobject instance,
                                                        jstring path_) {
...
Java_com_cry_screenop_recorder_rtmp_RtmpHandle_connect(JNIEnv *env, jobject instance,
                                                       jstring url_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cry_screenop_recorder_rtmp_RtmpHandle_push(JNIEnv *env, jobject instance, jbyteArray buf_,
                                                    jint length) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cry_screenop_recorder_rtmp_RtmpHandle_close(JNIEnv *env, jobject instance) {
// TODO
    if (rtmp != NULL) {
        RTMP_Close(rtmp);
        RTMP_Free(rtmp);
